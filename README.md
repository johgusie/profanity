...
### Releases
Latest release compiled for 64-bit Windows & Linux can be found [here](https://github.com/johgusie/profanity/releases).
...
usage: ./profanity [OPTIONS]
  ...
  About:
    ...
    Beer donations: 0x591279cF2B6f6D1C90561f88bE34839265267EEe
```
